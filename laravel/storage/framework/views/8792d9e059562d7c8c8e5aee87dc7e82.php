                ...
                <div class="flex space-x-4 overflow-x-auto">
                    <?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <img class="flex-none w-120 h-60 object-cover rounded-lg shadow-lg"
                            src="<?php echo e(Storage::url('imgfasilitas/' . $p->foto)); ?> alt=" Image description">
...
<?php echo $__env->make('layouts.main', ['title' => 'Pelayanan'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER\Documents\GitHub\Website-Puskesmas-Legok\laravel\resources\views/pelayanan.blade.php ENDPATH**/ ?>