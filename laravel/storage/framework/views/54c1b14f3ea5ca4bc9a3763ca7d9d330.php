                ...
                <div
                    ...
                    <div class="z-40 absolute md:col-span-2 inset-x-0 top-16 md:top-8 md:static bg-opacity-90 md:bg-opacity-0 bg-white items-center md:mr-8 lg:mr-10 xl:mr-[7.5rem] hidden mx-auto md:max-w-xl max-w-[26rem] lg:max-w-2xl md:flex rounded-md"
                        ...
                        <ul
                            ...
                            <li>
                                <a href="/"
                                    class="font-poppins block py-2 px-3 <?php echo e(Request::is('/') ? 'text-white md:text-black lg:text-black bg-green-700 font-bold' : 'text-gray-900'); ?> rounded md:bg-transparent lg:text-lg md:p-0 md:dark:text-black">Beranda</a>
                            </li>
                            <li>
                                <a href="/pelayanan"
                            ...
                            <li>
                                <a href="/tentangkami"
                                    class="font-poppins block py-2 px-3 <?php echo e(Request::is('tentangkami') ? 'text-white md:text-black lg:text-black bg-green-700 font-bold' : 'text-gray-900'); ?> rounded md:bg-transparent lg:text-lg md:p-0 md:dark:text-black">
                                    Tentang Kami</a>
                            </li>
                            <li>
                                <a href="/program-kegiatan"
                                    class="font-poppins block py-2 px-3 <?php echo e(Request::is('program-kegiatan') ? 'text-white md:text-black lg:text-black bg-green-700 font-bold' : 'text-gray-900'); ?> rounded md:bg-transparent lg:text-lg md:p-0 md:dark:text-black">
                                    Program & Kegiatan</a>
                            </li>
                        </ul>
                    </div>
...
<?php /**PATH C:\Users\Lenovo\OneDrive\Documents\Project\Website-Puskesmas-Legok\laravel\resources\views/layouts/main-jadwal-dokter.blade.php ENDPATH**/ ?>