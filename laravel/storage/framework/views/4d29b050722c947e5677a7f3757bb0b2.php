    ...
    <div class="container max-w-full h-full bg-background-green px-8 py-4">
        ...
        <div class="flex flex-row gap-8 justify-center pt-24  pb-5 overflow-auto">
            ...
            <div class="flex-shrink-0 w-[200px] h-[250px]  bg-white rounded-lg justify-center items-center shadow-lg overflow-hidden">
                <img class="object-cover w-full h-full" src="<?php echo e(Storage::url('imgpk/' . $p->foto)); ?>" alt="Foto">
            </div>
...
<div class="h-[32rem]">
    <div class="container max-w-full h-full bg-custom-color3 bg-opacity-70 px-8 py-4">
        ...
        <div class="flex flex-row gap-8 justify-center pt-24 overflow-x-auto pb-5">
            ...
            <div class="flex w-[200px] h-[250px] shrink-0 bg-transparent rounded-lg justify-center items-center shadow-lg">
                <img class="object-cover w-full h-full" src="<?php echo e(Storage::url('imgpost/' . $pos->foto)); ?>" alt="Foto">
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', ['title' => 'Program & Kegiatan'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\UAS AKhir\Website-Puskesmas-Legok\laravel\resources\views/progkegdepan/index.blade.php ENDPATH**/ ?>