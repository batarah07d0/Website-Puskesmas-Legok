...
<div class="columns">
    <div class="flex font-montserrat text-green-700 justify-left text-center lg:mt-12 px-4 lg:text-left lg:pl-64 sm:text-left sm:pl-20">
...
<div class="h-[20rem] lg:h-[40rem] bg-custom-color3">
            ...
            <div class="w-3/4 mx-auto flex flex-col justify-center border shadow-lg bg-white rounded-2xl py-2 px-4 font-bold leading-relaxed tracking-light text-green-700 font-montserrat">
                ...
                <form action="/daftaronline" class="w-full flex flex-col sm:flex-row items-center sm:items-start gap-2 md:gap-10">
                    ...
                    <select name="waktu_pelayanan" class="w-full rounded-lg bg-green-700 bg-opacity-20 px-2 py-1 text-sm sm:text-base" id="">
                        ...
                        <?php $__currentLoopData = $enumValue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="container max-w-full h-full lg:bg-custom-color3 md:relative bg-custom-color3">
        <div class="flex flex-col md:flex-row md:justify-center items-center lg:pt-52 md:gap-14 lg:gap-64 pt-0">
            <div class="flex flex-col font-montserrat scale-125 lg:scale-150">
                <div>
                    <div class="flex justify-center text-lg bg-white rounded shadow-lg font-bold text-green-700 lg:px-8">
                        Jadwal Pelayanan
                    </div>
                </div>
    ...
    <?php $__env->startSection('container'); ?>
    <div class="h-[20rem] lg:h-[40rem] bg-custom-color3">
        <div class="container flex justify-center z-40 max-w-full lg:max-w-full lg:absolute lg:block pt-0 md:pt-5 lg:pt-0 -translate-y-2/4">
            <div class="container flex max-w-sm md:max-w-full justify-center px-2 gap-2 md:px-5 md:gap-10 ">
                <div class="relative w-5/6 lg:w-3/4 mx-auto mt-16 md:m-0 flex flex-col justify-center border shadow-lg bg-white rounded-2xl py-2 px-4 font-bold leading-relaxed tracking-light text-green-700 font-montserrat">
                    ...
                    <form action="/daftaronline" class="w-full flex flex-col sm:flex-row items-center sm:items-start gap-1 md:gap-10 mb-1">
                        <select name="kategori" class="scale-y-110 md:scale-y-105 w-full rounded-lg bg-green-700 bg-opacity-20 px-2 py-1 text-xs md:text-base">
                            <option selected disabled>Jenis Layanan Kesehatan</option>
                            <?php $__currentLoopData = $enumValues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($value); ?>"><?php echo e($value); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <div class="relative w-full scale-y-90 md:scale-y-100" data-te-format24="true" id="timepicker-format" data-te-input-wrapper-init data-te-timepicker-init>
                            <input type="text" class="peer block min-h-[auto] w-full rounded-lg border-solid bg-green-700 bg-opacity-20 px-2 py-1 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0" data-te-toggle="timepicker" id="form14" oninput="toggleLabelVisibility()" />
...
<?php echo $__env->make('layouts.main', ['title' => 'Beranda'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\UAS AKhir\Website-Puskesmas-Legok\laravel\resources\views/welcome.blade.php ENDPATH**/ ?>