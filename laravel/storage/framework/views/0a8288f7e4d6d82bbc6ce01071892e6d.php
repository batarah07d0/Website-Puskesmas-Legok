...
<body>
    ...
    <div class="card shadow-lg px-6 mb-6">
        <div class="block justify-normal border mt-10 pb-5">
            <img src="<?php echo e(asset('storage/images/bocchi.jpg')); ?>" class="rounded-full w-24 mt-6 ml-7">
            <span>
    ...
    <div>
        <button
            ...
            <img src="<?php echo e(asset('storage/images/leftarrow.png')); ?>" class="ml-2 mt-2">
...
<?php /**PATH D:\xampp\htdocs\UAS AKhir\Website-Puskesmas-Legok\laravel\resources\views/detaildokter.blade.php ENDPATH**/ ?>