...
<body x-data="{ showModal: false, isApproved: false }" x-init="showModal = !isApproved">
    ...
    <?php if($quota <= 0): ?> <div class="mx-auto p-4 w-full max-w-4xl max-h-full" x-show="isApproved">
...
</html><?php /**PATH C:\Users\Lenovo\OneDrive\Documents\Project\Website-Puskesmas-Legok\laravel\resources\views/daftaronline.blade.php ENDPATH**/ ?>