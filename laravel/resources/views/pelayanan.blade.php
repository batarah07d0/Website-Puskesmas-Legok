...
@section('container')
    <div class="container max-w-full h-full bg-custom-color3 relative">
        <div class="flex flex-col md:flex-row md:justify-center items-center lg:pt-32 lg:gap-64 md:gap-16 py-20 md:py-32">
            <div
                class="flex flex-col text-green-700 font-montserrat scale-125 lg:scale-150 bg-white shadow-lg px-8 py-4 rounded-lg">
            ...
            <<<<<<< HEAD <div class="lg:flex md:flex flex-row justify-center items-center invisible md:visible">
                <div class="">
