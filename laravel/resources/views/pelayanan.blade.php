            ...
            <div class="container mx-auto px-4 py-8">
                ...
                <div class="mt-8">
                    <div class="flex space-x-4 overflow-x-auto">
                        <!-- Image 1 -->
                        <img class="flex-none w-120 h-60 object-cover rounded-lg shadow-lg" src="/path/to/your/image1.jpg" alt="Image description">
                        <!-- Image 2 -->
                        <img class="flex-none w-120 h-60 object-cover rounded-lg shadow-lg" src="/path/to/your/image2.jpg" alt="Image description">
