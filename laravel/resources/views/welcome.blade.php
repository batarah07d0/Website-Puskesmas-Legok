...
<div class="h-[30rem] lg:h-[40rem]">
    <div class="container z-10 max-w-full absolute block -translate-y-2/4 pt-8">
    ...
    <div class="container max-w-full h-full bg-custom-color3 relative">
        <div class="flex flex-col lg:flex-row lg:justify-center items-center lg:pt-52 lg:gap-64 pt-48">
            <div class="flex flex-col text-green-700 font-montserrat scale-110 lg:scale-150">
                <div class="flex justify-center text-lg bg-white rounded shadow-lg px-4">
                    Jadwal Pelayanan
                </div>
            </div>
...
<div class="h-[32rem] pt-0 lg:pt-14 sm:pt-14 bg-[#F5FFF4]">
