    ...
    <div class="h-[30rem] lg:h-[40rem]">
            ...
            <div class="container flex max-w-full justify-center px-2 gap-2 md:px-5 md:gap-10 ">
                <div
                    ...
                    <form action=""
                        ...
                        <select class="w-full rounded-lg bg-green-700 bg-opacity-20 px-2 py-1 text-sm sm:text-base"
                            id="">
        ...
        <div class="container max-w-full h-full bg-custom-color3 relative">
            <div class="flex flex-col lg:flex-row lg:justify-center items-center lg:pt-52 lg:gap-64 pt-40">
                <div class="flex flex-col font-montserrat scale-110 lg:scale-150">
                    <div>
                        <div class="flex justify-center text-lg bg-white rounded shadow-lg font-bold text-green-700 px-8">
                            Jadwal Pelayanan
                        </div>
                    </div>
                ...
                <div class="flex flex-row justify-center items-center">
                    <div class="">
                        <img src="../../img/logoPuskesmasLegok.png" class="w-48 lg:w-64 invisible lg:visible"
                            alt="Puskesmas Legok">
                    </div>
                    <div class="">
