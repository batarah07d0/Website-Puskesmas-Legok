                ...
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div class="lg:bg-opacity-0 bg-opacity-70 items-center justify-between hidden w-full md:flex md:w-auto md:order-1 z-50 rounded-md px-5"
                        ...
                        <ul
                            ...
                            <li>
                                <a href="/"
                                    class="font-poppins block py-2 px-3 {{ Request::is('/') ? 'text-black bg-green-700 font-bold' : 'text-gray-900' }} rounded md:bg-transparent md:p-0 md:dark:text-black">Beranda</a>
                            </li>
                            <li>
                                <a href="/pelayanan"
        ...
        <div class="flex flex-col items-center sm:items-start pt-4 sm:pt-0">
            ...
            <div class="grid grid-rows-3 gap-0 sm:gap-8 pt-0 w-full items-center">
                ...
                <div class="flex items-center justify-center sm:justify-start">
                    ...
                    <span class="ml-2">
                        <h3 class="font-montserrat text-slate-600 text-center sm:text-left">Jalan Panti Asuhan, RT.
                            001/002 Kelurahan
                            Babakan, Kec.
                            Legok,
            ...
            <div class="mapouter">
                <div class="gmap_canvas">
                    <iframe
                        ...
                        frameborder="0" scrolling="no" class="w-full h-0 sm:h-96"></iframe>
                </div>
            </div>
        </div>
    </div>
