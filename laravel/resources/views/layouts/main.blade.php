                ...
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div class="lg:bg-opacity-0 bg-opacity-70 items-center justify-between hidden w-full md:flex md:w-auto md:order-1 z-50 rounded-md px-5" id="navbar-search">
                        ...
                        <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium bg-color rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparant dark:bg-transparant md:dark:bg-transparant dark:border-black">
                            ...
                            <li>
                                <a href="/pelayanan" class="font-poppins block py-2 px-3 {{ Request::is('pelayanan') ? 'text-black bg-green-700 font-bold' : 'text-gray-900' }} rounded md:bg-transparent md:p-0 md:dark:text-black">
                                    Pelayanan</a>
                            </li>
                            <li>
                                <a href="/tentangkami" class="font-poppins block py-2 px-3 {{ Request::is('tentangkami') ? 'text-black bg-green-700 font-bold' : 'text-gray-900' }} rounded md:bg-transparent md:p-0 md:dark:text-black">
                                    Tentang Kami</a>
                            </li>
                            <li>
                                <a href="/program-kegiatan" class="font-poppins block py-2 px-3 {{ Request::is('program-kegiatan') ? 'text-black bg-green-700 font-bold' : 'text-gray-900' }} rounded md:bg-transparent md:p-0 md:dark:text-black">
                                    Program & Kegiatan</a>
                            </li>
                        </ul>
                    </div>
