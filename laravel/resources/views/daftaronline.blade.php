...
<body class="overflow-auto">
    ...
    <div class="grid justify-items-end ml-7 mt-9 mb-6 mr-7">
        <button class="bg-green-500 hover:bg-green-700 transition duration-300 text-white text-lg font-poppins w-48 border border-1 shadow-2xl rounded-md font-bold p-2 shadow-xl">
            KIRIM
        </button>
    </div>
    </form>
